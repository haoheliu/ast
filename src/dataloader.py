...
class AudiosetDataset(Dataset):
    ...
    def _wav2fbank(self, filename, filename2=None):
        ...
        # Mel spectrogram
        fbank = torchaudio.compliance.kaldi.fbank(waveform, htk_compat=True, sample_frequency=sr, use_energy=False, window_type='hanning', num_mel_bins=self.melbins, dither=0.0, frame_shift=self.hop_ms) 
        # fbank = torchaudio.compliance.kaldi.spectrogram(waveform, frame_shift=self.hop_ms, window_type='hanning', sample_frequency=sr)
        # fbank = torch.log(fbank + 1e-10)
